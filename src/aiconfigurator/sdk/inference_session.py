    ...
    * ``phase="both"`` — combines both above and reports end-to-end
    ...
    def _simulate_phase(
        ...
        *,
        ...
        # ``n_a_workers``.
        verification_width = max(int(getattr(a_model, "_nextn", 0)), 0) + 1
    ...
    def _build_summary(
        ...
        *,
        ...
        if decode_metrics is not None:
            ...
            decode_batch_service_time_ms = num_microbatches * tpot
            tokens_per_s = (
                b_total / (decode_batch_service_time_ms / 1000.0) if decode_batch_service_time_ms > 0 else 0.0
            )
        else:
            tpot = 0.0
